# How far it gets, and why it stops there

The working log for this port, kept because the wrong turns are as useful as the
conclusions — several findings here overturned an earlier one in the same
session, and those corrections are left in.

Images referenced below live beside this file.
...
![VF5 drawing the CRIWARE boot logo](criware.png)

![VF5 drawing its own NOW LOADING screen](now_loading.png)
